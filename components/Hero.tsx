    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <p className="mt-4 text-lg text-text-muted sm:text-xl">
          AI Engineer building agentic systems, RAG pipelines, and production
          AI tools.
        </p>
        <div className="mt-5 flex w-fit items-center gap-2 rounded-full border border-border bg-surface/80 px-3 py-1 text-xs text-text-muted backdrop-blur-sm">
