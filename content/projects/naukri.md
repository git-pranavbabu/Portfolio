---
title: "Naukri AI Candidate Shortlisting"
slug: naukri
oneLiner: "A two-agent Chrome extension that screens and ranks job candidates entirely client-side, cutting manual HR screening time by ~54 hrs/month."
hykon: true
order: 3
tech: ["Chrome extension", "Multi-agent", "Client-side LLM", "HR automation"]
links:
  github: ""
  live: ""
---
